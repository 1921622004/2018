...
var MyApp = _sanDev2.default.defineComponent({
    template: '' + '<div id="box">' + '<input type="text" class="input" value="{= person.name =}" placeholder="姓名">' + '<input type="text" class="input" value="{= person.age =}" placeholder="年龄">' + '<input type="text" class="input" value="{= person.des =}" placeholder="简介">' + '<p>信息：<input type="button" value="移除信息" on-click="del"></p>' + '<p>姓名：<span>{{person.name}}</span></p>' + '<p>年龄：<span>{{person.age}}</span></p>' + '<p>简介：<span>{{person.des}}</span></p>' + '</div>',
    ...
    person: _sanDev.DataTypes.shape({
        name: _sanDev.DataTypes.string,
        age: _sanDev.DataTypes.age,
        des: _sanDev.DataTypes.string
    }),
    del: function del() {
...
},{"san/dist/san.dev.js":6}],8:[function(require,module,exports) {
...
//# sourceMappingURL=/script.021c7748.map